...
contract StackupVault {
    ...
    function deposit(address tokenAddr, uint256 amount) external {
        ...
        tokens[tokenAddr].transferFrom(msg.sender, address(this), amount);
        require(tokens[tokenAddr].balanceOf(address(this)) == amount, "transferFrom failed");
    ...
    function withdraw(address tokenAddr, uint256 amount) external {
        ...
        require(tokens[tokenAddr].balanceOf(msg.sender) == amount, "transfer failed");
    }
}
